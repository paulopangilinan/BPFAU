...
Public Class rptReportSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Building_Permit_and_Licensing.rptReportSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptReportSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptReportSummary = New rptReportSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
