...
INSERT INTO `tblassessmentapplicant` (`ACN`,`Date`,`LastName`,`FirstName`,`MiddleName`,`Project`,`Lot`,`Block`,`Phase`,`SubdivisionCode`,`OtherInfo`,`Zone`,`BarangayCode`,`Remarks`,`PermitPre`,`PermitSub`,`PermitDate`,`Encoder`,`Additional`,`Status`) VALUES 
 ('0000001','2/14/2015','asd','asdas','','asdasd','asd','asd','asd','','ads','asd','03','ads','15','0000001','2/14/2015','001','NA','Pending');
...
INSERT INTO `tblbarangays` (`brgyID`,`brgyName`,`deleted`) VALUES 
 ('01','Baclaran',0),
 ('02','BF Homes',0),
 ('03','Don Bosco',0),
 ('04','Don Galo',0),
...
INSERT INTO `tbloccupancy` (`OCN`,`Date`,`Lastname`,`FirstName`,`MiddleName`,`OwnerAddress`,`Lot`,`Block`,`Phase`,`SubdivisionCode`,`OtherInfo`,`Zone`,`Barangay`,`OccupancyCode`,`StartDatePro`,`StartDateAct`,`CompleteDatePro`,`CompleteDateAct`,`TotalAreaEst`,`TotalAreaAct`,`Storeys`,`EstCost`) VALUES 
 ('0000001','2/14/2015','asd','asdas','','ggfgfg','asd','asd','asd','','ads','asd','03','7','2/14/2015','2/14/2015','2/14/2015','2/14/2015','2342','24234',24323,2423);
...
INSERT INTO `tblquestions` (`ID`,`Question`) VALUES 
 ...
 (3,'What was the name of your first stuffed animal or doll or action figure?'),
 (4,'What is your mother\'s maiden middle name?'),
 (5,'What was your favorite place to visit as a child?'),
 (6,'What is the first name of the person you first kissed?'),
 (7,'What is the last name of the teacher who gave you your first failing grade?'),
 (8,'What is the name of the place your wedding reception was held?'),
 (9,'In what city or town did you meet your spouse/partner?'),
 (10,'What was the maker and model of your first car?');
...
--
-- Definition of table `tbltrail`
--

DROP TABLE IF EXISTS `tbltrail`;
CREATE TABLE `tbltrail` (
  `Assessor` varchar(45) NOT NULL,
  `Date` varchar(45) NOT NULL,
  `Transaction` varchar(100) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `tbltrail`
--

/*!40000 ALTER TABLE `tbltrail` DISABLE KEYS */;
INSERT INTO `tbltrail` (`Assessor`,`Date`,`Transaction`) VALUES 
 ('1','02/03/2015 07:52:56','Accounts - Login - System Administrator'),
 ('1','02/03/2015 07:53:10','Accounts - Sign Out - ***'),
 ('1','02/03/2015 08:01:05','Accounts - Login - System Administrator'),
 ('1','02/03/2015 08:01:36','Accounts - Sign Out - ***'),
 ('1','02/03/2015 08:04:21','Accounts - Login - System Administrator'),
 ('1','02/03/2015 08:04:58','Accounts - Sign Out - ***'),
 ('1','02/06/2015 22:21:04','Accounts - Forgot Password - ***'),
 ('1','02/06/2015 22:21:12','Accounts - Reset Password - ***'),
 ('1','02/06/2015 22:21:14','Accounts - Login - System Administrator'),
 ('1','02/06/2015 22:21:30','Accounts - View Profile - System Administrator'),
 ('1','02/06/2015 22:21:44','Payment Summary - Summary - ***'),
 ('1','02/06/2015 22:21:48','Payment Summary - Summary - ***'),
 ('1','02/06/2015 22:21:59','Payment Summary - Print Summary - ***'),
 ('1','02/06/2015 22:25:37','Accounts - Sign Out - ***'),
 ('1','02/14/2015 22:25:28','Accounts - Login - System Administrator'),
 ('1','02/14/2015 22:25:56','Assessment - Add - 0000001'),
 ('1','02/14/2015 22:26:46','Occupancy - Add - 0000001'),
 ('1','02/14/2015 22:26:52','Accounts - Sign Out - ***'),
 ('1','02/14/2015 22:40:10','Accounts - Login - Login'),
 ('1','02/14/2015 22:40:18','Accounts - Sign Out - ***'),
 ('1','02/14/2015 22:41:16','Accounts - Login - Login'),
 ('1','02/14/2015 22:41:21','Accounts - View Profile - System Administrator'),
 ('1','02/14/2015 22:41:47','Accounts - Sign Out - ***'),
 ('1','02/14/2015 22:41:59','Accounts - Login - Login'),
 ('1','02/14/2015 22:43:48','Accounts - Sign Out - ***'),
 ('1','02/14/2015 22:56:03','Accounts - Login - Login'),
 ('1','02/14/2015 22:56:10','Accounts - View Profile - System Administrator'),
 ('1','02/14/2015 22:56:17','Accounts - Sign Out - ***'),
 ('1','02/14/2015 22:59:40','Accounts - Login - Login'),
 ('1','02/15/2015 00:02:04','Accounts - Login - Login'),
 ('1','02/15/2015 00:03:11','Accounts - Sign Out - ***'),
 ('1','02/15/2015 00:04:08','Accounts - Login - Login'),
 ('1','02/15/2015 00:05:31','Accounts - Sign Out - ***'),
 ('1','02/15/2015 00:05:57','Accounts - Login - Login'),
 ('1','02/15/2015 00:06:21','Accounts - Sign Out - ***'),
 ('1','02/15/2015 00:09:05','Accounts - Login - Login'),
 ('1','02/15/2015 00:10:40','Accounts - Sign Out - ***'),
 ('1','02/15/2015 00:11:49','Accounts - Login - Login'),
 ('1','02/15/2015 00:13:21','Accounts - Login - Login'),
 ('0','02/15/2015 00:13:54','Accounts - New User - paulo'),
 ('2','02/15/2015 00:14:01','Accounts - Login - Login'),
 ('2','02/15/2015 00:14:34','Accounts - Sign Out - ***'),
 ('1','02/15/2015 00:14:52','Accounts - Login - Login'),
 ('1','02/15/2015 00:15:19','Accounts - Sign Out - ***'),
 ('1','02/15/2015 11:51:19','Accounts - Login - Login'),
 ('1','02/15/2015 11:51:26','Accounts - View Profile - System Administrator'),
 ('1','02/15/2015 11:51:47','Accounts - View Profile - System Administrator'),
 ('1','02/15/2015 11:51:54','Accounts - Sign Out - ***'),
 ('1','02/15/2015 11:52:09','Accounts - Login - Login'),
 ('1','02/15/2015 11:52:15','Accounts - View Profile - System Administrator'),
 ('0','02/15/2015 21:44:44','Accounts - Forgot Password - ***'),
 ('0','02/15/2015 21:45:23','Accounts - Reset Password - ***'),
 ('1','02/15/2015 21:45:46','Accounts - Login - Login'),
 ('1','02/15/2015 21:45:53','Accounts - Sign Out - ***'),
 ('0','02/15/2015 22:06:04','Accounts - Forgot Password - ***'),
 ('0','02/15/2015 22:06:13','Accounts - Reset Password - ***'),
 ('1','02/15/2015 22:55:46','Accounts - Login - System Administrator'),
 ('1','02/15/2015 22:56:43','Accounts - Login - System Administrator'),
 ('0','02/15/2015 23:58:34','Accounts - Forgot Password - ***'),
 ('0','02/15/2015 23:58:43','Accounts - Reset Password - ***'),
 ('1','02/15/2015 23:58:49','Accounts - Login - Login'),
 ('1','02/15/2015 23:58:55','Accounts - View Profile - System Administrator'),
 ('1','02/15/2015 23:59:12','Accounts - Sign Out - ***');
/*!40000 ALTER TABLE `tbltrail` ENABLE KEYS */;
...
INSERT INTO `tblusers` (`UserID`,`UserType`,`UserDescription`,`Username`,`FirstName`,`LastName`,`MiddleName`,`UserPwd`,`UserImage`,`Question`,`Answer`) VALUES 
 (1,2,'Plumber','Admin','System','Administrator','','e10adc3949ba59abbe56e057f20f883e','',1,'NES'),
 (2,3,'Information Staff','paulo','Paulo','Pangilinan','N','21232f297a57a5a743894a0e4a801fc3',NULL,2,'Test');
